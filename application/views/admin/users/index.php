			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="dashboard_graph">
					...
					<div class="add-new text-right">
						...
						<button  onclick="add_users()"  class="btn btn-primary"><i class="fa fa-plus"></i> Thêm </button>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body form">
							...
							<div class="form-group">
								<label for="forgot_code">Forgot code*</label>
								<input type="password" class="form-control" name="forgot_code" placeholder="Mã quên mật khẩu...">
							</div>
