...
$(document).ready(function() {
    ...
    save_method = 'add';
        ...
        $('.modal-title').text('Thêm phương  thức thanh toán'); // Set Title to Bootstrap modal title
    }
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('.modal-title').text('Sửa thông tin thanh toán'); // Set title to Bootstrap modal title
